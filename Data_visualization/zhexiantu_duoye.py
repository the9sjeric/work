...
data_list = ["Average high", "Daily mean", "Average low", "Average precipitation", "Average ultraviolet index",
             "Mean monthly sunshine hours"]

# 将气候数据存入列表weather_list中
weather_list = [Average_high, Daily_mean, Average_low, Average_precipitation, Average_ultraviolet_index,
